---
source_url: https://docs.dolphindb.cn/zh/funcs/g/getPersistenceMeta.html
fetched_at: 2026-05-19T09:25:27Z
category: funcs
title: getPersistenceMeta
sha1: b618d1d60ac668f0eccdb7aab14ef2260010f3f5
---
...
- memoryOffset：内存数据相对于流表起始位置的偏移量，即内存中保留的最早记录在 totalSize
  中的位置。memoryOffset = totalSize - sizeInMemory
- sizeOnDisk：当前已经持久化到磁盘的记录数（包括已被清理的部分）
- diskOffset：磁盘数据相对于流表起始位置的偏移量，即磁盘上保留的最早记录在 totalSize
  中的位置。表示已被清理的数据量
