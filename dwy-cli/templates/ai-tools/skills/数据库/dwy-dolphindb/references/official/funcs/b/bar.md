---
source_url: https://docs.dolphindb.cn/zh/funcs/b/bar.html
fetched_at: 2026-05-19T09:13:36Z
category: funcs
title: bar
sha1: 642c501d4770f7044d2eabe6529b7b73a3f5707f
---
...
`bar` 基于 *interval* 指定的长度，根据分组计算公式，对 *X* 进行分组。
...
由于 *interval* 不支持年(y)和月(M)的时间单位，如果需要对
