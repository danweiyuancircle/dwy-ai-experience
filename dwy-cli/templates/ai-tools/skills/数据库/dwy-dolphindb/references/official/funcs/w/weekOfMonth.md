---
source_url: https://docs.dolphindb.cn/zh/funcs/w/weekOfMonth.html
fetched_at: 2026-05-19T09:43:56Z
category: funcs
title: weekOfMonth
sha1: 9a37a1de7b9e1bf12e29239d5e253ec90a9657f3
---
...
如果 *X* < *d* ，*weekOfMonth* 函数返回 *X*
的上一个月中第 *week* 个 *weekday* 对应的日期。

如果 *X* >= *d* ，*weekOfMonth* 函数返回 *X*
所在月份的第 *week* 个 *weekday* 对应的日期。
