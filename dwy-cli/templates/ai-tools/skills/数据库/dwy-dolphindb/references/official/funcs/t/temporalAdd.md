---
source_url: https://docs.dolphindb.cn/zh/funcs/t/temporalAdd.html
fetched_at: 2026-05-19T09:41:28Z
category: funcs
title: temporalAdd
sha1: 2fecb98de4e981e366bca5b9e48227595579d5ef
---
...
- *duration* 是整数时，*unit* 表示：
  ...
  - *duration* 的单位，取值可以是："ns"(nanosecond),
...
`temporalAdd` 单位为 M 或 y 的计算结果也一致。
