---
source_url: https://docs.dolphindb.cn/zh/funcs/u/unsubscribeTable.html
fetched_at: 2026-05-19T09:43:15Z
category: funcs
title: unsubscribeTable
sha1: 4743e6b64031659eebe6b97c998881a06e94919e
---
...
**tableName** 是表示取消订阅的流数据表名称的字符串。取消跨集群订阅 Orca
流表时，格式为`fqn@cluster_identifier`，例如
...
**raftGroup** 是在 [subscribeTable](../s/subscribeTable.html) 中设定的
raft 组的 ID，用于取消相应的订阅高端可用。

注：

`unsubscribeTable` 函数如果指定了
