---
source_url: https://docs.dolphindb.cn/zh/funcs/themes/orcaFunctions.html
fetched_at: 2026-05-19T09:44:41Z
category: funcs
title: Orca 系列
sha1: 1cc20a737a7694822916c482a6803c857aac9e96
---
...
在调用 Orca 函数前，必须先启用 Orca 功能，即在配置文件 cluster.cfg 或 controller.cfg 中配置
`enableORCA=true`）。
