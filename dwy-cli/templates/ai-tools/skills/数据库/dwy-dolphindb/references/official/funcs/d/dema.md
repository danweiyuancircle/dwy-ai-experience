---
source_url: https://docs.dolphindb.cn/zh/funcs/d/dema.html
fetched_at: 2026-05-19T09:18:45Z
category: funcs
title: dema
sha1: e5defd3ba44251c8ed54dac939748808c06f16fa
---
...
- 若 *X* 是一个向量，则返回一个 与 *X* 长度相同的向量，包含每个位置计算得到的 DEMA 值。
- 若 *X* 是一个矩阵，则返回一个与 *X* 维度相同的矩阵，每一列计算对应列的 DEMA 值。
- 若 *X* 是一个表，则返回一个与 *X* 维度相同的表，计算表中每一列的 DEMA 值。
