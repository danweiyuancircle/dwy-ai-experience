---
source_url: https://docs.dolphindb.cn/zh/tutorials/streaming_engine_anomaly_alerts_2.html
fetched_at: 2026-05-19T09:51:20Z
category: tutorials
title: 引擎级联监测门禁异常状态
sha1: f17c9f4fa5815b2c349c38b37f2f4c865af10b68
---
...
![](../stream/images/anomaly_alerts_1.png)  
...
首先定义一个用于实时接收门禁监控设备数据的流数据表，表结构共包含七列，通过`enableTableShareAndPersistence`函数共享流数据表并持久化到硬盘上。通过 *cacheSize* 参数将内存中可保存的最大数据量设定为 10 万行。代码如下：
