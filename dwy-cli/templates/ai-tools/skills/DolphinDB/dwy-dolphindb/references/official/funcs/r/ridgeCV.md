---
source_url: https://docs.dolphindb.cn/zh/funcs/r/ridgeCV.html
fetched_at: 2026-05-19T09:36:32Z
category: funcs
title: ridgeCV
sha1: 52d4fb3df5262d74d32b3fc68d1f65bf441289aa
---
...
使用五折交叉验证法进行岭回归（ridge）估计，输出最优参数对应的岭回归模型。
...
除 *alphas* 参数外，其它参数都和 ridge 的参数相同，参数描述可参考 [ridge](ridge.html)。这里仅说明 *alphas* 参数。
