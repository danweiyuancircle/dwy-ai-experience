---
source_url: https://docs.dolphindb.cn/zh/funcs/g/gppredict.html
fetched_at: 2026-05-19T09:27:03Z
category: funcs
title: gpPredict
sha1: 1780ea9eb5afc56fe8bdc8836f4f5d98c5ed19ee
---
...
采用上次训练得到的适应度函数较小的前 programNum 个公式用于预测。如果指定 groupCol，计算时还会依据 groupCol 分组。
...
返回一个表，共 programNum 列，列名为 gpFit 训练得到的公式。
