---
source_url: https://docs.dolphindb.cn/zh/funcs/d/DStream_keyedBuffer.html
fetched_at: 2026-05-19T09:19:54Z
category: funcs
title: Dstream::keyedBuffer
sha1: 3035763e6623f4d5f6bf79cb9fab35177ab89ce3
---
...
`DStream::keyedBuffer(name, keyColumn, [asyncWrite=true], [compress=true],
[cacheSize], [retentionMinutes=1440], [flushMode=0], [preCache],
[cachePurgeTimeColumn], [cachePurgeInterval], [cacheRetentionTime])`

## 详情

创建一个持久化键值流数据表，用于存储流计算中间结果。参考 [keyedStreamTable](../k/keyedStreamTable.html)。
