---
source_url: https://docs.dolphindb.cn/zh/funcs/c/createOrcaKeyedStreamTable.html
fetched_at: 2026-05-19T09:16:40Z
category: funcs
title: createOrcaKeyedStreamTable
sha1: 729369de92b9382273549363be87cebf0ef91bf7
---
...
`createOrcaKeyedStreamTable(name, keyColumn, colNames, colTypes,
...
创建一个持久化键值流数据表。参考 [keyedStreamTable](https://docs.dolphindb.cn/zh/funcs/k/keyedStreamTable.html) 和 [enableTableShareAndPersistence](https://docs.dolphindb.cn/zh/funcs/e/enableTableShareAndPersistence.html)。

与 `StreamGraph::keyedSource`
的区别在于，`createOrcaKeyedStreamTable` 无需依赖流图。
