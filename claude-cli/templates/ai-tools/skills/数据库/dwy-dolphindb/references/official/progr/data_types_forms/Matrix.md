---
source_url: https://docs.dolphindb.cn/zh/progr/data_types_forms/Matrix.html
fetched_at: 2026-05-19T09:00:41Z
category: progr
title: 矩阵
sha1: f7a9a745044b2c1d54274cc709c6d5912f7608f5
---
...
通过 [cast(X, m:n)](../operators/cast.html)
...
先使用 [rename!](../../funcs/r/rename_.html)
函数给矩阵增加行与列标签，再使用 [setIndexedMatrix!](../../funcs/s/setIndexedMatrix_.html) 函数将矩阵的行与列标签设为索引，即创建了一个索引矩阵。
...
通过 [indexedSeries](../../funcs/i/indexedSeries.html) 函数创建一个索引序列。
