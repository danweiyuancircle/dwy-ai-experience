---
source_url: https://docs.dolphindb.cn/zh/funcs/c/coevent.html
fetched_at: 2026-05-19T09:15:29Z
category: funcs
title: coevent
sha1: bdc4568588b5e1e2016e30d3e3aaffb014e5a650
---
...
返回的结果是一个表，包含 event1, event2 和 hits 三个字段。event1 和 event2 的数据类型与 *event* 相同，hits
是整数，表示事件对出现的次数。
