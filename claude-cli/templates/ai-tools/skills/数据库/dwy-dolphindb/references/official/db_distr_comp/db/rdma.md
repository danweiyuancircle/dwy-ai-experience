---
source_url: https://docs.dolphindb.cn/zh/db_distr_comp/db/rdma.html
fetched_at: 2026-05-19T09:04:41Z
category: db_distr_comp
title: 节点间传输协议
sha1: 493c008636123bc16ec3a65a3d9b3e209d75f61c
---
...
- 另一种常用方法是通过 OFED 提供的 [IPoIB](https://docs.nvidia.com/networking/display/mlnxofedv543750lts/ip+over+infiniband+(ipoib)) 高层协议（Upper Layer
...
| 运维函数 | 解释 |
| --- | --- |
| [getConnections](../../funcs/g/getConnections.html) | 获取当前节点的所有网络连接信息：两端 IP 和端口信息，连接建立时间。 |
