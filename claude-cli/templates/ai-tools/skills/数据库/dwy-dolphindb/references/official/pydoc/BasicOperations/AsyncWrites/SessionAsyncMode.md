---
source_url: https://docs.dolphindb.cn/zh/pydoc/BasicOperations/AsyncWrites/SessionAsyncMode.html
fetched_at: 2026-05-19T09:52:39Z
category: pydoc
title: session 异步提交
sha1: 8b7ec9f708bd6dc6919e9cd518dca3f3d9760412
---
...
Python API 开启 ASYNC（异步）模式的操作可以参照 [session](../Session/Constructor.html) 建立 DolphinDB 连接的部分，即设置 session 的 *enableASYNC* 参数为 True。通过这种方式异步写入数据可以节省 API 端检测返回值的时间。
