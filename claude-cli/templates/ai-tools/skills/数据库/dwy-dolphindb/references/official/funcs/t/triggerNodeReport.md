---
source_url: https://docs.dolphindb.cn/zh/funcs/t/triggerNodeReport.html
fetched_at: 2026-05-19T09:42:48Z
category: funcs
title: triggerNodeReport
sha1: c934c7af9550d678e74e7e4d04e5231adbd505c7
---
...
3. 若节点存活，但出现副本数不一致，在 controller 的日志中，搜索对应的
   chunkId，并定位出未汇报的数据节点。在该数据节点上调用 `triggerNodeReport` 强制触发其汇报
   chunk 信息。
4. 若此方法失效，建议重启节点。
