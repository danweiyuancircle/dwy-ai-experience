---
source_url: https://docs.dolphindb.cn/zh/deploy/deploy_intro.html
fetched_at: 2026-05-19T08:56:02Z
category: deploy
title: 部署
sha1: fa6db0ed729d3b510e37b1232c99b3e212338c87
---
...
- 节点启动后立即退出，在 log 文件中显示错误原因为 "`The license has expired`"。
  ...
  解决方案：联系 DolphinDB 技术支持 [support@dolphindb.com](mailto:support@dolphindb.com%EF%BC%8C%E6%9B%B4%E6%96%B0)，更新 license 文件
  *dolphindb.lic*。
- 集群管理器上启动节点后，节点仍然显示未启动状态。
  ...
  *server/log/\*.log*），里面有系统详细的运行日志；也可以联系 [support@dolphindb.com](mailto:support@dolphindb.com) 或致电 0571-82853925。
