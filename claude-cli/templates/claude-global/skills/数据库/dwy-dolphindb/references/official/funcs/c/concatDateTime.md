---
source_url: https://docs.dolphindb.cn/zh/funcs/c/concatDateTime.html
fetched_at: 2026-05-19T09:15:39Z
category: funcs
title: concatDateTime
sha1: b5852cc995e2bb1350844135981c687f52442ef8
---
...
如果 *time* 是 SECOND 类型，返回的结果是 DATETIME 类型；

如果 *time* 是 TIME 类型，返回的结果是 TIMESTAMP 类型；

如果 *time* 是 NANOTIME，返回的结果是 NANOTIMESTAMP 类型。
