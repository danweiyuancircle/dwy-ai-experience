---
source_url: https://docs.dolphindb.cn/zh/funcs/g/getTabletsMeta.html
fetched_at: 2026-05-19T09:26:29Z
category: funcs
title: getTabletsMeta
sha1: 477d7bcd76eba9499cf6660d768841b2c1c7af32
---
...
查询当前节点上指定数据表 chunk 的元数据信息。若结合 [pnodeRun](../p/pnodeRun.html)
函数使用，可返回所有节点上指定数据表的元数据信息。

注：

该函数不会返回记录条数为 0 的 chunk。如需查看，可使用[getClusterChunksStatus](getClusterChunksStatus.html)。
