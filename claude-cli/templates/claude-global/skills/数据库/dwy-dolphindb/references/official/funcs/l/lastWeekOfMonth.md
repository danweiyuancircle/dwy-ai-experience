---
source_url: https://docs.dolphindb.cn/zh/funcs/l/lastWeekOfMonth.html
fetched_at: 2026-05-19T09:29:28Z
category: funcs
title: lastWeekOfMonth
sha1: 3f91836f247402fe9cfdd4f77e1ada2f962dd5ee
---
...
- 如果 *X<d*，*lastWeekOfMonth* 函数返回 *X*
  的上一个月中最后一个 *weekday* 对应的日期。
- 如果 *X>=d*，*lastWeekOfMonth* 函数返回 *X*
  所在月份的最后一个 *weekday* 对应的日期。

如果指定了 *offset*，表示从 *offset* 开始，结果每隔 *n*
个月更新一次。注意，只有当 *n* >1时，*offset* 才会生效。
