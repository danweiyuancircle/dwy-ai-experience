---
source_url: https://docs.dolphindb.cn/zh/funcs/c/copy.html
fetched_at: 2026-05-19T09:15:53Z
category: funcs
title: copy
sha1: d8172de20cb5e331d89eb1d2a86179d2ccd263a9
---
...
DolphinDB 中的 copy 函数只支持浅拷贝；而 [pandas.DataFrame.copy](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.copy.html) 函数支持深拷贝和浅拷贝（通过
*deep* 参数控制）。
