---
source_url: https://docs.dolphindb.cn/zh/funcs/c/concat.html
fetched_at: 2026-05-19T09:15:38Z
category: funcs
title: concat
sha1: 86cf8303dba6e7fb49c0cab35acd9c7bbb684dba
---
...
- 当 *X* 为空时，若 *Y* 是空字符串或空字符，该函数返回一个空字符串；若 *Y* 是非空字符串或非空字符，该函数返回字符串
  *Y*。
...
- 当 *X* 非空时，若 *Y* 是空字符串或空字符，该函数将 *X* 的每个元素依次连接成一个新的字符串并返回；若
  *Y* 非空，该函数依次连接 *X* 中每个字符串（字符），并使用 *Y* 对它们分隔，返回新的字符串。
