---
source_url: https://docs.dolphindb.cn/zh/funcs/m/miminlast.html
fetched_at: 2026-05-19T09:31:52Z
category: funcs
title: miminLast
sha1: b41f3b15f98860153589f6a32baa26b73d6d4958
---
...
- 当 *X* 是向量时，返回一个整型向量，长度与输入向量相同。
- 当 *X* 是矩阵时，返回一个整型矩阵，形状与输入矩阵相同。
- 当 *X* 是表时，对表的每列进行计算，返回相应的结果。
- 当 *X* 是元组时，对元组中的每个向量分别计算，返回相应的结果。
