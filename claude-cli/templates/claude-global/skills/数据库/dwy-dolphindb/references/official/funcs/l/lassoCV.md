---
source_url: https://docs.dolphindb.cn/zh/funcs/l/lassoCV.html
fetched_at: 2026-05-19T09:29:25Z
category: funcs
title: lassoCV
sha1: 4790566edf7dd72a3a470bd6df1771003331cbf0
---
...
`lassoCV(ds, yColName, xColNames, [alphas=[0.01,0.1,1.0]], [intercept=true],
[normalize=false], [maxIter=1000], [tolerance=0.0001], [positive=false],
[swColName], [checkInput=true])`

## 详情

使用五折交叉验证方法进行 lasso 回归估计，输出最优参数对应的模型。
...
除 *alphas* 参数外，其它参数都和 [lasso](lasso.html)
