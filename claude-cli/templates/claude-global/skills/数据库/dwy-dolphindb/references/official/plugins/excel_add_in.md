---
source_url: https://docs.dolphindb.cn/zh/plugins/excel_add_in.html
fetched_at: 2026-05-19T09:45:47Z
category: plugins
title: Excel Add-In
sha1: ae32755e19f35025fc44de31a56c6513ac897bde
---
...
Excel 中 INT 的数据底层使用 DOUBLE 类型数据来存储。故填入 INT 类型的参数会转换成
