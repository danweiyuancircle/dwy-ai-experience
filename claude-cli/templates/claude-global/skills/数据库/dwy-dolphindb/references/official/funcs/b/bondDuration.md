---
source_url: https://docs.dolphindb.cn/zh/funcs/b/bondDuration.html
fetched_at: 2026-05-19T09:13:59Z
category: funcs
title: bondDuration
sha1: 061775fae80576f893192f19facd8ab38c2e8a5e
---
...
`bondDuration(start, maturity, issuePrice, coupon,
...
返回面值为 100 的债券的麦考利久期（Macauley Duration）。麦考利久期利用折现后的债券现金流的加权平均来计算债券的到期时间。
...
```dolphindb
bondDuration(start=2023.01.01, maturity=2030.12.31, issuePrice=100, coupon=0.05, frequency=1, dayCountConvention="ActualActualISMA", bondType="FixedRate", settlement=2023.04.01, price=0.03, priceType="YTM")

// output: 6.628495977602801
```

**相关函数**：[bondCalculator](bondCalculator.html)
