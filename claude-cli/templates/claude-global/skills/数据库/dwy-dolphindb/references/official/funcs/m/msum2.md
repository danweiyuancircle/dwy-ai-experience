---
source_url: https://docs.dolphindb.cn/zh/funcs/m/msum2.html
fetched_at: 2026-05-19T09:32:46Z
category: funcs
title: msum2
sha1: 376438d7ec3323b2648484376f119a375833ebd0
---
...
在给定长度（以元素个数或时间长度衡量）的滑动窗口内计算 *X* 元素的平方和。请注意，该函数的返回值是 DOUBLE
类型。
