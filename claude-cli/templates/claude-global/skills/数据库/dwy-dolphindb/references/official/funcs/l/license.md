---
source_url: https://docs.dolphindb.cn/zh/funcs/l/license.html
fetched_at: 2026-05-19T09:29:38Z
category: funcs
title: license
sha1: d49c54eda685ce1636552fa6426c3a555fd11237
---
...
若不指定 *fileName*，则默认读取保存在内存中的 license 信息
...
| moduleNames | 与 *modules* 有关，返回具体的模块名。目前支持返回：orderbook, internalFunction, cep, gpu, starfish, PowerTrading, Beluga, Backtest, MatchingEngineSimulator, starfishAI。社区版返回为空。 |
| productKey | 当前产品类型。目前支持返回：DOLPHIN, IOTBASIC, IOTPRO, SHARK, SWORDFISH, ORCA, DOLPHINX。 |
