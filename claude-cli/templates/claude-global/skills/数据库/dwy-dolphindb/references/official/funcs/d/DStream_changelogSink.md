---
source_url: https://docs.dolphindb.cn/zh/funcs/d/DStream_changelogSink.html
fetched_at: 2026-05-19T09:19:40Z
category: funcs
title: DStream::changelogSink
sha1: 5fa999263a172c4fb7d1afcca5ed3c99163aec4b
---
...
`DStream::changelogSink(name, keyColumn, [asyncWrite=true],
...
将流数据输出至包含状态列的持久化键值流数据表。

有关流数据表的更多信息，请参阅 [changelogStreamTable](../c/changelogStreamTable.html) 手册。
...
**相关函数**：[changelogStreamTable](../c/changelogStreamTable.html)、[enableTableShareAndPersistence](../e/enableTableShareAndPersistence.html)、[StreamGraph::changelogSource](../s/StreamGraph_changelogSource.html)
