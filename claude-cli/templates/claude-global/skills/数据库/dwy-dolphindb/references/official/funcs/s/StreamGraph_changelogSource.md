---
source_url: https://docs.dolphindb.cn/zh/funcs/s/StreamGraph_changelogSource.html
fetched_at: 2026-05-19T09:40:20Z
category: funcs
title: StreamGraph::changelogSource
sha1: fd8ef1a91e37b5cd208f62749f345529c60b8fe3
---
...
`StreamGraph::changelogSource(name, keyColumn, colNames,
...
创建一个包含状态列的持久化键值流数据表。参考 [changelogStreamTable](../c/changelogStreamTable.html) 和 [enableTableShareAndPersistence](../e/enableTableShareAndPersistence.html)。
...
**preCache** 可选参数，是一个整数，表示从磁盘加载到内存的记录条数。如果没有指定该参数，重启后实际加载到内存的数据量受
*cacheSize* 限制。
...
**cacheRetentionTime** 可选参数，DURATION 类型标量，表示内存中数据的最长保留期限。
...
**相关函数**：[changelogStreamTable](../c/changelogStreamTable.html)、[enableTableShareAndPersistence](../e/enableTableShareAndPersistence.html)、DStream::changelogSink
