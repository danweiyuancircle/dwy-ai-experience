---
source_url: https://docs.dolphindb.cn/zh/funcs/s/setTSDBCacheEngineSize.html
fetched_at: 2026-05-19T09:39:10Z
category: funcs
title: setTSDBCacheEngineSize
sha1: d593b57d10ce246f25c69e937e1a3fd53c14be06
---
...
*TSDBCacheEngineSize* )。可以通过 `getTSDBCacheEngineSize`
查看设置是否生效。
...
**memSize** 一个数值型标量（单位为GB），必须大于0且小于 *maxMemSize* \*
0.5。
