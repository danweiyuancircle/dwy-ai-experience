---
source_url: https://docs.dolphindb.cn/zh/funcs/w/writeRecord.html
fetched_at: 2026-05-19T09:44:14Z
category: funcs
title: writeRecord
sha1: 92981649cb785827efc3f2ede67282388a80b1fa
---
...
`writeRecord` 函数把 DolphinDB 对象（例如表或元组）转换为二进制文件。
