---
name: dwy-vue-core
description: "Vue 3 + TypeScript + Vite + Tailwind 项目基础代码风格规范。触发条件：编写或审查 .vue 组件、vite.config、composables、路由配置；需要确认组件结构 / 命名规范 / TS 类型标注 / 模板与样式写法 / 导入顺序 / 错误处理 / 中文注释规范 / 常见反模式 / 代码自检清单 / 代码简约原则。"
---
